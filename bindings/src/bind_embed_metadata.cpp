...
namespace pydeepstream {
    ...
    void bindembedding(py::module &m) {
        ...
        m.def("alloc_embedding_struct",
              [](NvDsUserMeta *meta) {
                  auto *mem = (EmbeddingMetadata *) g_malloc0(
                          sizeof(EmbeddingMetadata));
                  meta->base_meta.copy_func = (NvDsMetaCopyFunc) pydeepstream::copy_embedding_struct;
                  meta->base_meta.release_func = (NvDsMetaReleaseFunc) pydeepstream::release_embedding_struct;
                  return mem;
              },
              py::return_value_policy::reference,
